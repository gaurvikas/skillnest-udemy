        ...
        <div class="p-6">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    {{ __('Update role and assign permissions') }}</p>
            </div>

            <form method="POST" action="{{ route('admin.roles.update', $role->id) }}" class="space-y-6" id="roleForm">
                @csrf
                @method('PUT')
                ...
                <div>
                    <x-forms.input label="Role Name" name="name" type="text"
                        placeholder="e.g., Admin, Instructer, Student" required
